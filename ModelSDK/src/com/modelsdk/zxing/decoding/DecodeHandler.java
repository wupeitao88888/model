...
import com.modelsdk.zxing.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(activity.getHandler(), ResourcesUtil.getId(activity, "decode_succeeded"),
                    rawResult);
            ...
            Message message = Message.obtain(activity.getHandler(), ResourcesUtil.getId(activity, "decode_failed"));
            message.sendToTarget();
        }
    }

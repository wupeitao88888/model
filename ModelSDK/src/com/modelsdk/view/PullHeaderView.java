...
import com.modelsdk.utils.DateUtil;
...
public class PullHeaderView extends LinearLayout {
	...
	private void init(Context context) {
		...
		progressBar.setIndeterminateDrawable(this.getResources().getDrawable(R.drawable.progress_circular));
	...
	public int setRefreshing() {
		...
		tvDate.setText("上次刷新时间:"+DateUtil
				.getCurrentDate(DateUtil.dateFormatHMS));

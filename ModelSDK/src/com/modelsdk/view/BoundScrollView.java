...
public class BoundScrollView extends ScrollView {
	 ...
	 * 自定义的弹性滚动视图
	 */
	private BoundScrollWarpLayout mContentLayout;
	...
	public BoundScrollView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * 功能描述:初始化滚动视图 <br>
	 * <br>
	 * <strong>策略:</strong> 获取ScrollView的子视图并添加到自定义的{@link BoundScrollWarpLayout}滚动视图中
	...
	private void initOverScrollLayout() {
		...
		if(mContentLayout == null){
			...
			// 初始化弹性滚动视图
			mContentLayout = new BoundScrollWarpLayout(getContext());
			// 移除ScrollView所有视图
			this.removeAllViews();

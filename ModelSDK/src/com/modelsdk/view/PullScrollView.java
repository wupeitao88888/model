...
public class PullScrollView extends ScrollView {
	...
	private PullFooterView			footerView;
	...
	private void addheaderView() {
		headerView = new PullHeaderView(mContext);
	...
	private void addfooterView() {
		footerView = new PullFooterView(mContext);
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				xLast = curX;
				yLast = curY;
				L.e(xDistance+"++++++++"+yDistance);
				if (xDistance+5 >= yDistance) {
					L.e("++++++++++++++++++++++++++++++++++++++++++++false");
					return false;
				}else{
					L.e(xDistance+"++++++++++++++++++++++++++++++++++++++++++++true"+yDistance);
					return true;
				}

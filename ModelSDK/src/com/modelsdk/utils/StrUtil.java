...
public class StrUtil {
    ...
    public static String  format(String text) {
        ...
        if(text.lastIndexOf("\\u002")>-1){
            if("\\u0020".lastIndexOf("\\u002"+text.charAt(text.lastIndexOf("\\u002")+5))>-1){
                System.out.println(text);
                return mJson=text;
            }else{
                text=text.replace("\\u002"+text.charAt(text.lastIndexOf("\\u002")+5), "\\u0020"+text.charAt(text.lastIndexOf("\\u002")+5));
                format(text);
            }
        }else{
            System.out.println(text);
